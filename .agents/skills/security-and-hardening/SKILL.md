...
- **Bound consumption (LLM10: Unbounded Consumption).** Bound request rate, loop/recursion depth, and workload fan-out so a crafted input can't hang or overwhelm the system.
