...
- No default gate may invoke stress fixtures, incident fixtures, full Waterflow verification, broad unit discovery, async fan-out, workspace-wide safety sweeps, or scratch-durability sweeps.
