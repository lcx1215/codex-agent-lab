...
- `python3 -m unittest discover -s tests` covers 19 path(s), risk `P2`, routes `auditor-code`, `script`.
- `scripts/check-lab` covers 61 path(s), risk `P2`, routes `agent`, `script`, `skill`.
- `scripts/waterflow-scan --root /Users/liuchengxu/Desktop/codex-agent-lab` covers 76 path(s), risk `P2`, routes `agent`, `auditor-code`, `documentation`, `registry`, `script`, `skill`.
